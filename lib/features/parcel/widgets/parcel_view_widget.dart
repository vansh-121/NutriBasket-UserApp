                              ...
                              onChange: (int? value, int index) async {
                                if (parcelController.isSender) {
                                  ...
                                  AddressModel pickupAddress = AddressModel(
                                    ...
                                    addressType:
                                        senderAddress[index].addressType,
                                    contactPersonNumber: senderAddress[index]
                                        .contactPersonNumber,
                                    contactPersonName:
                                        senderAddress[index].contactPersonName,
                                    address: senderAddress[index].address,
                                    latitude: senderAddress[index].latitude,
                                    longitude: senderAddress[index].longitude,
                                  ...
                                  parcelController.setCountryCode(
                                      _addressCountryCode ?? _countryCode!,
                                      true);
                                  ...
                                  AddressModel a = AddressModel(
                                    ...
                                    addressType:
                                        receiverAddress[index].addressType,
                                    contactPersonNumber: receiverAddress[index]
                                        .contactPersonNumber,
                                    contactPersonName: receiverAddress[index]
                                        .contactPersonName,
                                    address: receiverAddress[index].address,
                                    latitude: receiverAddress[index].latitude,
                                    longitude: receiverAddress[index].longitude,
                                    zoneId: responseModel.isSuccess
                                        ? responseModel.zoneIds[0]
                                        : 0,
                                    zoneIds: responseModel.zoneIds,
                                    method: receiverAddress[index].method,
                                    streetNumber:
