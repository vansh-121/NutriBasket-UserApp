                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      !widget.fromChatPage
                          ? CustomTextField(
                              ...
                              titleText:
                                  'type_here_to_write_a_custom_message'.tr,
                              showLabelText: false,
                              maxLines: 3,
                              ...
                              onChanged: (value) {
                                setState(() {
                                  isTextFieldNotEmpty =
                                      massageTextController.text.isNotEmpty;
                                });
                              },
                            )
                          : const SizedBox(),
                                ...
                                ? () async {
                                    ...
                                    await Get.toNamed(RouteHelper.getChatRoute(
                                      ...
                                      orderChatModel: OrderChatModel(
                                        ...
                                        reason: (orderController
                                                        .supportReasons !=
                                                    null &&
                                                orderController.supportReasons!
                                                    .isNotEmpty &&
                                                selectIndex != -1)
                                            ? orderController
                                            ...
                                            : '',
                                        customMessage:
                                            massageTextController.text.trim(),
                                      ),
                                    ));
